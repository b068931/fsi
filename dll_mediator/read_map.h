...
public:
	...
	private:
		...
		states_builder* states_builder_back_reference{};
...
private:
	...
	std::vector<std::unique_ptr<state_type>> states;
	std::forward_list<state_settings> states_settings;
...
public:
	...
	state_settings& create_state(types&&... values) {
	...
	state_settings& create_anonymous_state(
