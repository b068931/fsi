...
namespace generic_parser {
    ...
    protected:
        using redirection_information_type =
            std::pair<state<token_type, context_key_type, objects_type, parameters_object_type, parameters_enumeration_type>*, state_action>;

        using custom_function_signature = typename get_function_signature<parameters_object_type>::value;
    ...
    public:
        ...
        friend class state_settings<token_type, context_key_type, objects_type, parameters_object_type, parameters_enumeration_type>;
        friend class states_builder<token_type, context_key_type, objects_type, parameters_object_type, parameters_enumeration_type>;
    };
    ...
    public:
        virtual void handle_token(
            objects&, parameters_object_type&,
            read_map<token_type, context_key_type, objects, parameters_object_type, parameters_enumeration_type>&
        ) {
        ...
        typename base::redirection_information_type get_redirection_from_custom_functions(
            ...
            parameters_object_type& parameters_object
        ) {
    ...
    public:
        virtual void handle_token(
            objects_type&,
            read_map<token_type, context_key_type, objects_type, void, parameters_enumeration_type>&
        ) {
            //this function was intentionally left empty
        }
    ...
    class read_map_base {
    protected:
        using state_type = state<token_type, context_key_type, objects_type, parameters_object_type, parameters_enumeration_type>;
...
#pragma clang diagnostic pop
    ...
    public:
        read_map_base(token_type end, token_type name, token_generator<token_type, context_key_type>* token_generator)
            :name_token{ name },
    ...
    public:
        read_map(token_type end, token_type name, token_generator<token_type, context_key_type>* token_generator)
            :base{ end, name, token_generator }
        {
        }

        void handle_token(objects_type* builder_object, token_type token, parameters_object_type* parameters) {
    ...
    public:
        ...
        void handle_token(objects_type* builder_object, token_type token) {
            typename base::state_type* top_state = this->states_stack.top();
            if (this->initialize_handle(token, top_state)) {
    ...
    class states_builder {
        ...
        template<>
        struct get_function_signature<void> {
            using value = void(objects&, read_map<token_type, context_key_type, objects, parameters_object_type, parameters_enumeration_type>&);
        };

    public:
        using state_type =
            state<token_type, context_key_type, objects, parameters_object_type, parameters_enumeration_type>;

        using state_settings_type =
            state_settings<token_type, context_key_type, objects, parameters_object_type, parameters_enumeration_type>;

        using custom_function_signature =
            typename state_type::custom_function_signature;

        using anonymous_function_signature = typename get_function_signature<parameters_object_type>::value;
    ...
    public:
        ...
        state_settings_type& create_anonymous_state(
            ...
            return this->template create_state<anonymous_state<parameters_object_type, anonymous_function_signature>>(
