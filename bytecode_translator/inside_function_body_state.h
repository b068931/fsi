...
public:
	virtual void handle_token(
		...
		if (token == structure_builder::source_file_token::function_args_start) { //special case for function call
			helper.active_function.add_new_instruction(structure_builder::source_file_token::function_call);
			...
			helper.active_function.add_new_instruction(structure_builder::source_file_token::module_call);
			helper.active_function.add_new_operand_to_last_instruction(structure_builder::source_file_token::no_return_module_call_keyword, nullptr, false);
			if (name != "void") {
