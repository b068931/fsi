...
const char* STARTUP_COMPONENTS_ADDRESS_SANITIZER_ACTIVE = "ADDRESS SANITIZER ENABLED";
#else
const char* STARTUP_COMPONENTS_ADDRESS_SANITIZER_ACTIVE = "ADDRESS SANITIZER DISABLED";
#endif
