#ifndef MODULE_INTEROPERATION_H
#define MODULE_INTEROPERATION_H
...
namespace interoperation {
    ...
    public:
        ...
        static std::size_t program_loader_load_program_to_memory() {
            static std::size_t index = get_module_part()->find_function_index(program_loader(), "load_program_to_memory");
            return index;
        }
        ...
        static std::size_t program_loader_get_function_name() {
            static std::size_t index = get_module_part()->find_function_index(program_loader(), "get_function_name");
            return index;
        }
        ...
        static std::size_t resource_module_create_new_thread() {
            static std::size_t index = get_module_part()->find_function_index(resource_module(), "create_new_thread");
            return index;
        }
        ...
        static std::size_t resource_module_deallocate_program_container() {
            static std::size_t index = get_module_part()->find_function_index(resource_module(), "deallocate_program_container");
            return index;
        }

        static std::size_t resource_module_deallocate_thread() {
            static std::size_t index = get_module_part()->find_function_index(resource_module(), "deallocate_thread");
            return index;
        }

        static std::size_t resource_module_get_running_threads_count() {
            static std::size_t index = get_module_part()->find_function_index(resource_module(), "get_running_threads_count");
            return index;
        }

        static std::size_t resource_module_get_program_container_id() {
            static std::size_t index = get_module_part()->find_function_index(resource_module(), "get_program_container_id");
            return index;
        }
        ...
        static std::size_t resource_module_duplicate_container() {
            static std::size_t index = get_module_part()->find_function_index(resource_module(), "duplicate_container");
            return index;
        }
