...
struct thread_local_structure {
	arguments_string_type initializer{}; //contains data that will be passed to the main function in thread
	...
	return_value priority; //store thread priority information between calls
