...
USER_PROGRAM_PROGRAM_CONTROL_FUNCTIONS_DISPLACEMENT     EQU 48
...
CONTROL_CODE_TEMPLATE_SPECIAL_CALL_MODULE             DQ (SPECIAL_CALL_MODULE_ENDP - CONTROL_CODE_TEMPLATE_CALL_MODULE_TRAMPOLINE)
...
SPECIAL_CALL_MODULE_ENDP LABEL BYTE
...
CONTROL_CODE_TEMPLATE_RESUME_PROGRAM_EXECUTION PROC
    ...
    mov r10, [rcx + USER_PROGRAM_PROGRAM_CONTROL_FUNCTIONS_DISPLACEMENT]
