...
void cleanse_string(module_mediator::pointer string, module_mediator::eight_bytes size) {
...
module_mediator::return_value generic_log_message(module_mediator::arguments_string_type bundle, log_type log) {
	auto arguments = 
		module_mediator::arguments_string_builder::unpack<
			module_mediator::pointer, module_mediator::eight_bytes, module_mediator::pointer, module_mediator::pointer
		>(bundle);
