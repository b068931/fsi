...
compiled_program compile(
    ...
    try {
        ...
        return compiled_program{
            ...
            static_cast<uint32_t>(container.exposed_functions.size()),
...
module_mediator::return_value load_program_to_memory(module_mediator::arguments_string_type bundle) {
    //prog_load(load_program_to_memory)->resm(create_new_prog_container)->excm(on_container_creation)
    ...
    try {
        ...
        run_reader<runs_container> reader(program_name, &container,
            {
