...
public:
	generic_variable(
		std::uint8_t variable_real_type, 
		std::uint8_t variable_active_type, 
		entity_id variable_id
	)
		:variable_with_id{ variable_id },
		real_type{ variable_real_type },
		active_type{ variable_active_type }
	{}
