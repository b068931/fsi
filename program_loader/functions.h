...
enum class termination_codes : int32_t {
	stack_overflow = 1,
	nullptr_dereference,
...
constexpr uint32_t program_termination_code_size = 11;
constexpr uint32_t stack_allocation_code_size = 12 + program_termination_code_size;
constexpr uint32_t function_save_return_address_size = 12;
